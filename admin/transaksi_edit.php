		...
		<div class="panel-body">
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<?php
					...
					// mengambil data pelanggan yang ber id di atas dari table pelanggan
				...
				?>
					<form method="post" action="transaksi_update.php">
								...
								<select class="form-control" name="pelanggan" required="required">
									<option value="">- Pilih Pelanggan</option>
										<?php 
											...
											// mengubah data ke array dan menampilkannya dengan perulanagn while
						...
						<table class="table table-bordered table-striped">
							...
							<?php
								// menyimpan id transaksi ke variable id_transaksi
								$id_transaksi = $t['transaksi_id'];

								// menyimpan pakaian-pakaian dari transaksi yang ber id di atas
